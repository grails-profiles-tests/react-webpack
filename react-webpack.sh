...
mv react-webpack multi/react-webpack

mv multi/react-webpack/gradle multi/gradle

mv multi/react-webpack/gradlew multi/gradlew

mv multi/react-webpack/gradlew.bat multi/gradlew.bat
...
echo "include 'react-webpack', 'functional-tests'" >> settings.gradle
